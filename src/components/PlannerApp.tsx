...
import { PlannerCanvas, type PlannerCanvasHandle } from './canvas/PlannerCanvas'
...
export default function PlannerApp() {
  ...
  const handleClearAll = useCallback(() => {
    if (window.confirm('Clear all shapes, lines and images? (Background and masks will be kept)')) {
